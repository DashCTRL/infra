...
data "template_file" "cloud_init" {
    template  = templatefile("${path.module}/cloud-init/cloud-init.tftpl", { vm=local.vm_name, domain=local.domain, ssh_pub_key=local.ssh_pub_key })
...
resource "proxmox_vm_qemu" "vm" {
    ...
    # cicustom      = "user=ubuntu,password=ubuntu,hostname=${local.vm_name}"
